<ul class="nav-pills nav nav-sidebar">
  ...
  <!--<li role="presentation" class="<?php echo ($current == 'account_linked') ? 'active' : ''; ?>"><?php echo anchor('account/account_linked', lang('website_linked')); ?></li>-->
