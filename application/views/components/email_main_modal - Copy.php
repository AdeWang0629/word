        ...
        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-8 pull-right settlement_letter_aria" id="settlement_letter_aria"
            ...
            <div class="col-lg-12" style="padding: 0;">
                ...
                <table class="table table-bordered" style="margin-bottom: 0;">
                    <tr>
                        <td><input type="checkbox" id="settlement_letter_choice1" name="settlement_letter_choice" value="purchase"> 物品購入 </td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" id="settlement_letter_choice2" name="settlement_letter_choice" value="expenses"> 交通費 </td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" id="settlement_letter_choice3" name="settlement_letter_choice" value="other"> その他 </td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" id="settlement_letter_choice3" name="settlement_letter_choice" value="other"> 履歴 </td>
                    </tr>
                </table>
                <!-- </div>
            </div>  -->
                ...
                <div class="email_list_container">
                    <div class="email_list_container2">
                        ...
                        <table class="table table-hover" id="email_list">
                            ...
                            <tr>
                                <th colspan="6">
                                    <center>読み込み中。。。待って下さい<img src="<?= base_url("resource/img/ajax/ajax_load_8.gif") ?>"></center>
                                </th>
                            </tr>                 
