...
if($_SERVER['SERVER_NAME'] === 'localhost'){
    $config['base_url'] = 'http://localhost/keipro_combo/word/';
    ...
    $config['base_url'] = 'https://keipro.development.dhaka10.dev.jacos.jp/word/';
}
...
|--------------------------------------------------------------------------
|
| It use for Android App api validation.
|
*/
...
// $config['sess_expiration']   = 7200; // For 2 Hourse
// $config['sess_expiration']   = 604800; // For 1 week
$config['sess_expiration']      = 0; // For no expiration
