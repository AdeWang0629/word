! function() {
    ...
    h("b", tinymce.util.Tools.resolve), g("1", ["b"], function(a) {
        ...
        var c = function(a, b, c) {
            ...
            e = function(a, b, e, f) {
                var g, h, i = 0,
                    j = d(a, b, e);
                for (g = e;
                     (f > 0 ? g < a.length : g >= 0) && (h = c(a, b, g), j === h.elm); g += f) i++;
                return i
            },
            f = function(a, b, c) {
            ...
            g = function(a, c) {
                for (var d, f = [], g = a[c], h = 0; h < g.length; h++) d = g[h], f.push({
                    elm: d.elm,
                    above: e(a, h, c, -1) - 1,
                    below: e(a, h, c, 1) - 1
        ...
        return function(h, i, j) {
            ...
            function A(a, b, c, d) {
                ...
                for (e = Z[b][a].elm.parentNode, g = 1; g <= c; g++)
                    if (e = ca.getNext(e, "tr")) {
                        ...
                        if (f == -1)
                            for (h = 1; h <= d; h++) e.insertBefore(y(e.cells[0]), e.cells[0])
                    }
            }
            ...
            function H(b, c, d) {
                ...
                if (b ? (f = T(b), h = f.x, i = f.y, j = h + (c - 1), k = i + (d - 1)) : (_ = aa = null, e(Z, function(a, b) {
                    ...
                    for (w === $ && x === Z.length && (w = 1, x = 1), w === $ && x > 1 && (x = 1), g(o, "colSpan", w), g(o, "rowSpan", x), m = i; m <= k; m++)
                        for (l = h; l <= j; l++) Z[m] && Z[m][l] && (b = Z[m][l].elm, b != o && (q = a.grep(b.childNodes), e(q, function(a) {
                            o.appendChild(a)
            ...
            function S(b, c) {
                ...
                b && (h = d.splitAt(Z, _.x, _.y, c), i = h.row, a.each(h.cells, p), j = a.map(b, function(a) {
                    ...
                    var h, j, k, m, n = a.cells.length,
                        q = 0;
                    for (o(a), h = 0; h < n; h++) j = a.cells[h], m = f(j, "colspan"), k = f(j, "rowspan"), q += m, k > 1 && (q--, b + k > d.length ? (k = d.length - b, g(j, "rowSpan", k), l.push(d.length - 1)) : l.push(b + k - 1)), p(j);
                    for (e(l, function(a) {
                        b <= a && q++
                    }), h = q; h < $; h++) a.appendChild(y(a.cells[n - 1]));
                    for (h = $; h < q; h++) j = a.cells[a.cells.length - 1], m = f(j, "colspan"), m > 1 ? g(j, "colSpan", m - 1) : ca.remove(j);
            ...
            function W(a) {
                ...
                if (aa = T(a), _ && aa) {
                    for (b = Math.min(_.x, aa.x), c = Math.min(_.y, aa.y), d = Math.max(_.x, aa.x), e = Math.max(_.y, aa.y), f = d, g = e, l = c; l <= e; l++)
                        for (j = b; j <= d; j++) a = Z[l][j], a.real && (h = a.colspan - 1, i = a.rowspan - 1, h && j + h > f && (f = j + h), i && l + i > g && (g = l + i));
                    for (k(), l = c; l <= g; l++)
        ...
        return function(d) {
            ...
            function F(a, b, c, d) {
                ...
                if (e) e = {
                    ...
                    for (var f = a.slice(0, b).reverse(), g = 0; g < f.length; g++) f[g] && (e = {
                        value: f[g],
                        delta: g + 1
                    });
                var h = a[b + 1];
                if (h) h = {
                    ...
                    for (var i = a.slice(b + 1), j = 0; j < i.length; j++) i[j] && (h = {
                        value: i[j],
                        delta: j + 1
                    });
            ...
            function S(b, c, e) {
                ...
                for (var j = y(b), k = z(j), l = Q(b.width) || Q(b.style.width), m = I(k, l, b), n = l ? q(b, c) : c, s = L(m, e, n, va, l, b), t = [], u = 0; u < s.length; u++) t.push(s[u] + m[u]);
                var v = N(k, t),
                    w = l ? "%" : "px",
                    x = l ? g() : h();
                d.undoManager.transact(function() {
            ...
            function T(b, c, e) {
                for (var f = y(b), g = z(f), h = K(g), i = [], j = 0, k = 0; k < h.length; k++) i.push(k === e ? c + h[k] : h[k]), j += j[k];
                var l = O(g, i),
                    m = P(g, i);
                d.undoManager.transact(function() {
                    a.each(m, function(a) {
            ...
            var fa, ga, ha, ia, ja, ka, la = "mce-resize-bar",
            ...
            function n() {
                var b = "\ufeff",
                    ...
                    e = function(a, b) {
                        var c = b.firstChild;
                        do
                            if (c === a) return !0; while (c = c.firstChild);
                        return !1
                    },
                    f = function(a) {
                        if (3 === a.nodeType) {
        ...
        function k(a) {
            ...
            function k(b, c, d) {
                function e() {
                    var e, f, g, h = {},
                        i = 0;
                    f = a.dom.select("td[data-mce-selected],th[data-mce-selected]"), e = f[0], e || (e = a.selection.getStart()), d && f.length > 0 ? (l(f, function(a) {
            ...
            function t() {
                ...
                "" !== b && b !== !1 && (b || (b = "tableprops tabledelete | tableinsertrowbefore tableinsertrowafter tabledeleterow | tableinsertcolbefore tableinsertcolafter tabledeletecol"), a.addContextToolbar(s, b))
            }
            ...
            var w, x, y = this,
                z = new h(a);
            !a.settings.object_resizing || a.settings.table_resize_bars === !1 || a.settings.object_resizing !== !0 && "table" !== a.settings.object_resizing || (x = i(a)), a.settings.table_grid === !1 ? a.addMenuItem("inserttable", {
                text: "Table",
                icon: "table",
                context: "table",
                onclick: z.table
                ...
                menu: [{
                    ...
                    onmousemove: function(a) {
                        var b, c, d = a.target;
                        "A" == d.tagName.toUpperCase() && (b = parseInt(d.getAttribute("data-mce-x"), 10), c = parseInt(d.getAttribute("data-mce-y"), 10), (this.isRtl() || "tl-tr" == this.parent().rel) && (b = 9 - b), b === this.lastX && c === this.lastY || (q(b, c, a.control), this.lastX = b, this.lastY = c))
                    },
                    onclick: function(b) {
                        var c = this;
            ...
            l("inserttable tableprops deletetable | cell row column".split(" "), function(b) {
            ...
            }), y.quirks = new j(a), a.on("Init", function() {
                ...
                mceTableMergeCells: function(b) {
                    var c;
                    c = a.dom.getParent(a.selection.getStart(), "th,td"), a.dom.select("td[data-mce-selected],th[data-mce-selected]").length ? b.merge() : z.merge(b, c)
                },
            ...
            }), r(), t(), a.settings.table_tab_navigation !== !1 && a.on("keydown", function(b) {
                var c, d, g, h = a.selection.getStart();
                if (b.keyCode === e.TAB) {
            ...
            }), y.insertTable = d, y.setClipboardRows = v, y.getClipboardRows = u
        }
        var l = d.each;
        return c.add("table", k),
            function() {}
    }), d("0")()
}();