  ...
  initialize : function( JS_IM_Obj ){
    ...
    stateDisplay : {
      ...
      init : function(){
        ...
        stateDisplayElem.style.fontSize = '16px';
        stateDisplayElem.style.textAlign = 'center';
        stateDisplayElem.style.width = '24px';
        stateDisplayElem.style.height = '24px';
        ...
        stateDisplayElem.style.position = 'fixed';
        stateDisplayElem.style.top = '0px';
        stateDisplayElem.style.left = 'calc(50%)';
        stateDisplayElem.style.visibility = "hidden";
        
        //var stateDisplayElem = $('<div style="font-size: 16px;text-align: center;width: 24px;height: 24px;border: 1px solid rgb(0, 0, 0);background: rgb(255, 255, 204);position: fixed;top: 34px;right: 147px;visibility: visible;"></div>').first();
    ...
    buffer : {
      ...
      update : function( bufferStr ){
        ...
        this.elem.style.width = ( ( JS_IM_Common.stripTags(bufferStr).length * 18 ) + 15 ) + "px";
        this.flush();
      },
      flush : function(){
        this.elem.style.visibility = "visible";
