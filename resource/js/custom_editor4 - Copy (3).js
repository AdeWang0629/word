...
function rearrange(text, length) {
    ...
    var o=$('#paginate'),
    // var o=tinymce.activeEditor.dom.select('div#paginate').first(),
        h=//o.height(),
        c=$('<div/>').css('width',o.width()).addClass('part'),
        cc,i=1,item;
    // var o = tinymce.activeEditor.dom.add(tinymce.activeEditor.getBody(), 'div', {id: 'paginate'}, '');
    console.log(o);
    // var o = tinymce.activeEditor.dom.add(tinymce.activeEditor.getBody(), 'div', {id: 'paginate'}, '');
    // var c = document.createElement("div");
    // c.setAttribute("class", "part"); // appends the class "page" to the element
    // o.appendChild(c);
    // var cc;
    // var h=o.height();
    // var i=1;
